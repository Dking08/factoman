...
- **Multi-User Sync & Token Directory (Supabase)**:
  ...
  - **User Token Lookup**: Store user tokens by nickname/key in Supabase (`user_tokens` table, e.g. `"bablu"` -> `"Absfpypdx6XFjueps4TgJDjF"`).
...
3. To add tokens for your friends:
   ...
   VALUES ('bablu', 'Absfpypdx6XFjueps4TgJDjF');
   ```
